  ...
  return (
    <div className="py-16 bg-gray-50 min-h-screen flex items-center">
      <div className="container mx-auto px-4 sm:px-6 lg:px-24">
        <SectionHeading
          title="Welcome Back"
          description="Sign in to continue to your courses and dashboard"
        />

        <div className="max-w-5xl mx-auto mt-8 bg-white rounded-2xl shadow-lg overflow-hidden grid grid-cols-1 lg:grid-cols-2">
          {/* Left Image */}
          <div className="hidden lg:flex items-center justify-center bg-linear-to-br from-[#f0fafa] to-[#e6eded] p-8">
            <Image
